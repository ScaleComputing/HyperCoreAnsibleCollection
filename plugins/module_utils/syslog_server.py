...
from ..module_utils.typed_classes import TypedSyslogServerFromAnsible
...
class SyslogServer(PayloadMapper):
    ...
    def get_by_uuid(
        ...
        hypercore_dict = rest_client.get_record(f"{REST_API_VERSION}/AlertSyslogTarget", query, must_exist=must_exist)
    ...
    def get_by_host(
        ...
        hypercore_dict = rest_client.get_record(f"{REST_API_VERSION}/AlertSyslogTarget", {"host": host}, must_exist=must_exist)
        if hypercore_dict is None:
            return None
    ...
    def get_all(
        ...
        syslog_servers = [
            ...
            for hypercore_dict in rest_client.list_records(f"{REST_API_VERSION}/AlertSyslogTarget/")
        ]
        syslog_servers.sort()
    ...
    def create(
        ...
        task_tag = rest_client.create_record(f"{REST_API_VERSION}/AlertSyslogTarget/", payload, check_mode)
    ...
    def update(
        ...
        task_tag = rest_client.update_record(f"{REST_API_VERSION}/AlertSyslogTarget/{self.uuid}", payload, check_mode)
        TaskTag.wait_task(rest_client, task_tag)
    ...
    def delete(
        ...
        task_tag = rest_client.delete_record(f"{REST_API_VERSION}/AlertSyslogTarget/{self.uuid}", check_mode)
        TaskTag.wait_task(rest_client, task_tag)
