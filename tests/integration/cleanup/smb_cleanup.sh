...
smbclient //$1$2 -U ${username[1]}%$4 -D 'integration-test-vm-export' << SMBCLIENTCOMMANDS
ls
SMBCLIENTCOMMANDS

smbclient //$1$2 -U ${username[1]}%$4 -D 'integration-test-vm-import' << SMBCLIENTCOMMANDS
ls
SMBCLIENTCOMMANDS
