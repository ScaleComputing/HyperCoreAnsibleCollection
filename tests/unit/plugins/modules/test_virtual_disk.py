...
class TestEnsurePresent:
    @pytest.mark.parametrize(
        ...
        ("cluster_before_virtual_disk_dict", "cluster_after_virtual_disk_dict", "disk_file_info", "expected_result", "expected_exception"),
        [
            # Disk exists on cluster
            ...
            (dict(name="this.vhd", uuid="asdf-1245", blockSize="10240", capacityBytes="1999999", replicationFactor="3"), dict(), dict(file_content="", file_size=""), (False, None, dict(before=None, after=None)), False),
            (dict(name="this.xvhd", uuid="asdf-1245", blockSize="10240", capacityBytes="1999999", replicationFactor="3"), dict(), dict(file_content="", file_size=""), (False, None, dict(before=None, after=None)), False),
            (dict(name="this.img", uuid="asdf-1245", blockSize="10240", capacityBytes="1999999", replicationFactor="3"), dict(), dict(file_content="", file_size=""), (False, None, dict(before=None, after=None)), False),
            (dict(name="this.vmdk", uuid="asdf-1245", blockSize="10240", capacityBytes="1999999", replicationFactor="3"), dict(), dict(file_content="", file_size=""), (False, None, dict(before=None, after=None)), False),
            # Disk not exist on cluster
            ...
            (dict(), dict(name="notfoobar.xvhd", uuid="123456", blockSize="1024", capacityBytes="199999", replicationFactor="1"), dict(file_content=bytes(545647), file_size=10240), (True, dict(name="notfoobar.xvhd", uuid="123456", block_size="1024", size="199999", replication_factor="1"), dict(before=None, after=dict(name="notfoobar.xvhd", uuid="123456", block_size="1024", size="199999", replication_factor="1"))), False),
            (dict(), dict(name="notfoobar.img", uuid="123456", blockSize="1024", capacityBytes="199999", replicationFactor="1"), dict(file_content=bytes(545647), file_size=10240), (True, dict(name="notfoobar.img", uuid="123456", block_size="1024", size="199999", replication_factor="1"), dict(before=None, after=dict(name="notfoobar.img", uuid="123456", block_size="1024", size="199999", replication_factor="1"))), False),
            (dict(), dict(name="notfoobar.vmdk", uuid="123456", blockSize="1024", capacityBytes="199999", replicationFactor="1"), dict(file_content=bytes(545647), file_size=10240), (True, dict(name="notfoobar.vmdk", uuid="123456", block_size="1024", size="199999", replication_factor="1"), dict(before=None, after=dict(name="notfoobar.vmdk", uuid="123456", block_size="1024", size="199999", replication_factor="1"))), False),
                # Disk file Exception
            ...
            (dict(), dict(name="foobar.vhd", uuid="123", blockSize="1000", capacityBytes="1000000", replicationFactor="2"), dict(), (True, dict(name="foobar.vhd", uuid="123", block_size="1000", size="1000000", replication_factor="2"), dict(before=None, after=dict(name="foobar.vhd", uuid="123", block_size="1000", size="1000000", replication_factor="2"))), True),
            (dict(), dict(name="foobar.xvhd", uuid="123", blockSize="1000", capacityBytes="1000000", replicationFactor="2"), dict(), (True, dict(name="foobar.xvhd", uuid="123", block_size="1000", size="1000000", replication_factor="2"), dict(before=None, after=dict(name="foobar.xvhd", uuid="123", block_size="1000", size="1000000", replication_factor="2"))), True),
            (dict(), dict(name="foobar.img", uuid="123", blockSize="1000", capacityBytes="1000000", replicationFactor="2"), dict(), (True, dict(name="foobar.img", uuid="123", block_size="1000", size="1000000", replication_factor="2"), dict(before=None, after=dict(name="foobar.img", uuid="123", block_size="1000", size="1000000", replication_factor="2"))), True),
            (dict(), dict(name="foobar.vmdk", uuid="123", blockSize="1000", capacityBytes="1000000", replicationFactor="2"), dict(), (True, dict(name="foobar.vmdk", uuid="123", block_size="1000", size="1000000", replication_factor="2"), dict(before=None, after=dict(name="foobar.vmdk", uuid="123", block_size="1000", size="1000000", replication_factor="2"))), True),
    ...
    def test_ensure_present_virtual_disk(self, create_module, rest_client, mocker, cluster_before_virtual_disk_dict, cluster_after_virtual_disk_dict, disk_file_info, expected_result, expected_exception):
        module = create_module(
            params = dict(
                cluster_instance=dict(
                    host="https://my.host.name", username="user", password="pass"
...
class TestEnsureAbsent:
    @pytest.mark.parametrize(
        ...
        ("cluster_before_virtual_disk_dict", "cluster_after_virtual_disk_dict", "expected_result"),
        [
            # VD already deleted / not exist
            (dict(), dict(), (False, None, dict(before=None, after=None))),       
            # VD exists / needs to be deleted
            (dict(name="foobar.qcow2", uuid="123", blockSize="1000", capacityBytes="1000000", replicationFactor="2"), dict(), (True, None, dict(before=dict(name="foobar.qcow2", uuid="123", block_size="1000", size="1000000", replication_factor="2"), after=None))),       
            (dict(name="foobar.vhd", uuid="asdf-123-qwe", blockSize="1024", capacityBytes="12222000000", replicationFactor="5"), dict(), (True, None, dict(before=dict(name="foobar.vhd", uuid="asdf-123-qwe", block_size="1024", size="12222000000", replication_factor="5"), after=None))),
            (dict(name="foobar.xvhd", uuid="fake-uuid-456", blockSize="2056", capacityBytes="1500000000", replicationFactor="3"), dict(), (True, None, dict(before=dict(name="foobar.xvhd", uuid="fake-uuid-456", block_size="2056", size="1500000000", replication_factor="3"), after=None))),
            (dict(name="foobar.img", uuid="3456456", blockSize="200056", capacityBytes="1123000000", replicationFactor="1"), dict(), (True, None, dict(before=dict(name="foobar.img", uuid="3456456", block_size="200056", size="1123000000", replication_factor="1"), after=None))),
            (dict(name="foobar.vmdk", uuid="1233343", blockSize="399999", capacityBytes="1455000000", replicationFactor="0"), dict(), (True, None, dict(before=dict(name="foobar.vmdk", uuid="1233343", block_size="399999", size="1455000000", replication_factor="0"), after=None))),
        ],
    )
    def test_ensure_absent_virtual_disk(self, create_module, rest_client, mocker, cluster_before_virtual_disk_dict, cluster_after_virtual_disk_dict, expected_result):
        module = create_module(
            params = dict(
                cluster_instance=dict(
                    host="https://my.host.name", username="user", password="pass"
...
# Test test_wait_task_and_get_updated() module function.
class TestWaitTaskAndGetUpdated:
    @pytest.mark.parametrize(
        ...
        [
            ...
            (dict(name="foobar.qcow2", uuid="123", blockSize="1000", capacityBytes="1000000", replicationFactor="2"), True, dict(before=dict(name="foobar.qcow2", uuid="123", block_size="1000", size="1000000", replication_factor="2"), after=None)),
            (dict(name="foobar.vhd", uuid="123", blockSize="1000", capacityBytes="1000000", replicationFactor="2"), True, dict(before=dict(name="foobar.qcow2", uuid="123", block_size="1000", size="1000000", replication_factor="2"), after=None)),
            (dict(name="foobar.xvhd", uuid="123", blockSize="1000", capacityBytes="1000000", replicationFactor="2"), True, dict(before=dict(name="foobar.qcow2", uuid="123", block_size="1000", size="1000000", replication_factor="2"), after=None)),
            (dict(name="foobar.img", uuid="123", blockSize="1000", capacityBytes="1000000", replicationFactor="2"), True, dict(before=dict(name="foobar.qcow2", uuid="123", block_size="1000", size="1000000", replication_factor="2"), after=None)),
            (dict(name="foobar.vmdk", uuid="123", blockSize="1000", capacityBytes="1000000", replicationFactor="2"), True, dict(before=dict(name="foobar.qcow2", uuid="123", block_size="1000", size="1000000", replication_factor="2"), after=None)),
            # Corner case: after present, virtual disk not exist
            #(),
            # After absent action, Must exist=False
            (dict(name="foobar.qcow2", uuid="123", blockSize="1000", capacityBytes="1000000", replicationFactor="2"), False, dict(before=dict(name="foobar.qcow2", uuid="123", block_size="1000", size="1000000", replication_factor="2"), after=None)),
            (dict(name="foobar.vhd", uuid="123", blockSize="1000", capacityBytes="1000000", replicationFactor="2"), False, dict(before=dict(name="foobar.qcow2", uuid="123", block_size="1000", size="1000000", replication_factor="2"), after=None)),
            (dict(name="foobar.xvhd", uuid="123", blockSize="1000", capacityBytes="1000000", replicationFactor="2"), False, dict(before=dict(name="foobar.qcow2", uuid="123", block_size="1000", size="1000000", replication_factor="2"), after=None)),
            (dict(name="foobar.img", uuid="123", blockSize="1000", capacityBytes="1000000", replicationFactor="2"), False, dict(before=dict(name="foobar.qcow2", uuid="123", block_size="1000", size="1000000", replication_factor="2"), after=None)),
            (dict(name="foobar.vmdk", uuid="123", blockSize="1000", capacityBytes="1000000", replicationFactor="2"), False, dict(before=dict(name="foobar.qcow2", uuid="123", block_size="1000", size="1000000", replication_factor="2"), after=None)),
            # Corner case: after absent, virtual disk still exist
        ],
    )
    def test_wait_task_and_get_updated_virtual_disk(self, create_module, rest_client, mocker, updated_virtual_disk_dict, must_exist, expected_result):
        module = create_module(
            params = dict(
                cluster_instance=dict(
                    host="https://my.host.name", username="user", password="pass"
